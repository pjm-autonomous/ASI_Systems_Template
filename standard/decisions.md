...
| **D-65** | **Adversarial review ships as skills; agents follow separately.** Skills are harvested in their own PR, agents afterwards in PRs grouped by type or function for incremental addition. A skill carries its counted failure or it is not harvested. | 2026-09-14 | H-1, SE |
