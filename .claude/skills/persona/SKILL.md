---
name: persona
description: Create or update a persona artifact in stakeholder/personas/. Use when the user wants to add a stakeholder, actor, or persona to the artifact tree.
---

# Skill: persona

Create or update a persona artifact in `stakeholder/personas/`.
...
Then create `stakeholder/personas/<name>.md` from `templates/persona.md`:
...
If `stakeholder/personas/<name>.md` already exists:
